...
class UpdateSegmentCommand extends smithy_client_1.Command {
    ...
    serialize(input, context) {
        return Aws_restJson1_1_1.serializeAws_restJson1_1UpdateSegmentCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1_1.deserializeAws_restJson1_1UpdateSegmentCommand(output, context);
    }
}
