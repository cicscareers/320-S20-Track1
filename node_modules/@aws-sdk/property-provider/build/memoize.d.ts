 ...
 */
export declare function memoize<T>(provider: Provider<T>): Provider<T>;
/**
 ...
 *                          otherwise.
 */
export declare function memoize<T>(provider: Provider<T>, isExpired: (resolved: T) => boolean, requiresRefresh?: (resolved: T) => boolean): Provider<T>;
