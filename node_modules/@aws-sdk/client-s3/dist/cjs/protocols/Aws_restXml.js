...
async function serializeAws_restXmlHeadBucketCommand(input, context) {
    ...
    let body;
    return new protocol_http_1.HttpRequest(Object.assign(Object.assign({}, context.endpoint), { protocol: "https", method: "HEAD", headers: headers, path: resolvedPath, body: body }));
}
...
async function serializeAws_restXmlHeadObjectCommand(input, context) {
    ...
    let body;
    return new protocol_http_1.HttpRequest(Object.assign(Object.assign({}, context.endpoint), { protocol: "https", method: "HEAD", headers: headers, path: resolvedPath, query: query, body: body }));
}
