import { h, r as registerInstance } from './index-04570516.js';
import { I18n } from '@aws-amplify/core';
import { T as Translations } from './Translations-bcdbf36c.js';
...
const AmplifyAuthFields = class {
    ...
    constructFormFieldOptions(formFields) {
        ...
        if (formFields === undefined)
            return '';
        formFields.forEach((formField) => content.push(componentFieldMapping[typeof formField === 'string' ? formField : formField.type](formField)));
        return content;
    }
    render() {
