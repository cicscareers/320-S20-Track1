...
handleTabContent=(event)=>{
  ...
  fil.push(supporter);
    ...
    return this.state.start_time.split(":");
      ...
      console.log(slot_start_exact_time+" "+slot_end_exact_time+" "+f_start_exact_time+" "+f_end_exact_time);
      ...
      ||(slot_start_exact_time<=f_start_exact_time&&slot_end_exact_time>f_start_exact_time)||(slot_start_exact_time<f_end_exact_time&&slot_end_exact_time>=f_end_exact_time)){
      ...
      if(f.length!=0){
       ...
       slot_start_exact_time=slot_start_hour + (slot_start_min/100);
       slot_end_exact_time=slot_end_hour + (slot_end_min/100);
